            ...
            <section className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-blue-400/20">
              ...
              <div className="space-y-6">
                <div className="bg-slate-700/50 rounded-lg p-6 border-l-4 border-purple-400">
                  ...
                  <p className="text-gray-300">
                    Expert led projections for player performance and injury risk assessment. Advanced algorithms analyze historical data to predict future outcomes and identify trends.
                  </p>
                </div>
